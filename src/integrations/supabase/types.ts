  ...
  public: {
    Tables: {
      ...
      flow_comments: {
        ...
        Relationships: [
          {
            foreignKeyName: "flow_comments_node_id_fkey"
            columns: ["node_id"]
            isOneToOne: false
      ...
      flow_edges: {
        ...
        Relationships: [
          {
            foreignKeyName: "flow_edges_project_id_fkey"
            columns: ["project_id"]
            isOneToOne: false
      ...
      flow_nodes: {
        ...
        Relationships: [
          {
            foreignKeyName: "flow_nodes_project_id_fkey"
            columns: ["project_id"]
            isOneToOne: false
            referencedRelation: "projects"
            referencedColumns: ["id"]
      ...
      project_wireframes: {
        ...
        Relationships: [
          {
            foreignKeyName: "project_wireframes_project_id_fkey"
            columns: ["project_id"]
            isOneToOne: false
            referencedRelation: "projects"
            referencedColumns: ["id"]
      ...
      wireframe_pages: {
        Row: {
          ...
          order_index: number
          project_id: string | null
          status: Database["public"]["Enums"]["wireframe_page_status"]
          title: string
          updated_at: string
        }
        Insert: {
        ...
        Relationships: [
          {
            foreignKeyName: "wireframe_pages_category_id_fkey"
            columns: ["category_id"]
            isOneToOne: false
            referencedRelation: "wireframe_categories"
            referencedColumns: ["id"]
          },
        ]
      }
    ...
    Enums: {
      ...
      wireframe_page_status: "not_started" | "in_progress" | "completed"
    }
    CompositeTypes: {
      content_block: {
        type: string | null
