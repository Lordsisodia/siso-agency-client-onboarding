    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-black to-siso-dark p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">Congratulations!</h1>
          <p className="text-gray-300 text-lg mb-6">
            You've completed the onboarding process. We're excited to have you join our community!
          </p>
        </div>
