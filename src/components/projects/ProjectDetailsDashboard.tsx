...
import { TrendingUp, TrendingDown, Clock, AlertTriangle, Target, DollarSign, Users } from 'lucide-react';

interface ProjectDetailsDashboardProps {
  project: TaskProject;
}

export const ProjectDetailsDashboard: React.FC<ProjectDetailsDashboardProps> = ({ project }) => {
  ...
  // Calculate efficiency score (simplified indicator)
  ...
  return (
    <Card className="mb-6 border-border/40 bg-card/50 hover:bg-card/80 shadow-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <div className="md:col-span-3">
            ...
            <div className="space-y-3">
              <div className="bg-muted/30 p-3 rounded-lg">
                ...
                <ul className="text-sm space-y-2">
                  <li className="flex justify-between">
                    <span className="text-muted-foreground">Phase progress updated</span>
              ...
              <div className="bg-muted/30 p-3 rounded-lg">
                <h4 className="text-sm font-medium mb-2">Team Productivity</h4>
                <div className="flex justify-between mb-1">
                  <span className="text-sm text-muted-foreground">This Week</span>
                  <span className="text-sm">85%</span>
                </div>
                <Progress value={85} className="h-1.5 bg-muted" indicatorClassName="bg-blue-500" />
              </div>
            </div>
          </div>
        </div>
