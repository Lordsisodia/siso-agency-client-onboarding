      ...
      <div className="flex items-center gap-3">
        <div className="relative hidden md:flex max-w-[320px]">
          <Input 
            ...
            className="pr-9 bg-gradient-to-r from-siso-bg/80 to-siso-bg/60 border-siso-border/40 focus:border-siso-orange/50 pl-10"
          />
        ...
        >
          <Button variant="ghost" size="icon" className="relative">
            ...
            <span className="absolute -top-1 -right-1 bg-gradient-to-r from-siso-red to-siso-orange text-white text-xs rounded-full h-5 w-5 flex items-center justify-center shadow-md">
              3
            </span>
          </Button>
        </motion.div>
        ...
        <TooltipProvider>
          <Tooltip>
            <TooltipTrigger asChild>
              ...
              >
                <Card className="flex items-center p-2 bg-gradient-to-r from-siso-bg/80 to-siso-bg/60 border border-siso-border/50 hover:border-siso-orange/40 transition-colors shadow-sm">
                  {userData?.avatarUrl ? (
                    <div className="h-8 w-8 rounded-full overflow-hidden border-2 border-siso-orange/20 mr-2">
                      <img 
